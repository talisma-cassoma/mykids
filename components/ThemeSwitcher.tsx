...
} from "../context/theme-switch/types";
import {
  DEFAULT_ANIMATION_DURATION,
  DEFAULT_ANIMATION_TYPE,
  DEFAULT_SWITCH_DELAY,
  DEFAULT_EASING,
} from "../context/theme-switch/conf";
import { wait, getEasingFunction, getMaxRadius } from "../context/theme-switch/helpers";
    ...
    const animateThemeChange = async <T extends number, U extends number>(
      ...
      if (viewRef.current) {
        const snapshot = await makeImageFromView<View>(
          // makeImageFromView expects RefObject<View> (non-nullable). Cast to satisfy TS
